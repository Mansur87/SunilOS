...
<div class="container-fluid">
	...
	<div class="modal-body">			  
     ...
     <div class="row" style="margin-left:3px;">
				...
				<div class="col-md-3">
			    <div class="form-group">
			    <s:message code="label.enterdescription" var="createdBy"/>
			    <sf:input path="roleDescription" cssClass="form-control" placeholder="${createdBy}"  />
               </div>
				</div>
       ...
       <div class="table-responsive">
        <table class="table table-hover table-dark ">
          <thead>
            ...
            <%--   <th><s:message code="label.createdBy"/></th> --%>
         ...
         <h3 class="success justify-content-center  text-center "><font color="green"> ${success}</font></h3>
          ...
          <tbody id="" class="text-white" style="background-color:black; ">
          <c:if test="${!empty list}">
           ...
           <tr>
              ...
              <input type="checkbox" class="form-check-input" name="chk_1" id="sid" onchange="check()" 
              <c:choose>
              ...
              </c:choose><c:if test="${role.id==1}">disabled</c:if>>
            ...
            <c:out value="${(form.pageSize * (form.pageNo-1))+ct.index+1}" />
              ...
              <a href="${editUrl}${role.id}"><s:message code="label.edit"/> <i class="fas fa-edit"></i></a>
              </c:when>
              <c:otherwise>
              ----
              </c:otherwise>
