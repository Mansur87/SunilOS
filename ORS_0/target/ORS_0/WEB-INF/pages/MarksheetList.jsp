...
<div class="container-fluid">
	...
	<div class="modal-body">	  
     ...
     <div class="row" style="margin-left:3px;">
                ...
                <sf:option value="0" label="${enterrollno}" />
                <sf:options items="${studentList}" itemValue="id" itemLabel="rollNo"/>
                </sf:select> 
				...
				<div class="col-md-3">
			    <div class="form-group">
			    <s:message code="label.searchByStudent" var="select"></s:message>
         ...
         <h3 class="success justify-content-center  text-center "><font color="green"> ${success}</font></h3>
          ...
          <c:if test="${!empty list}">
           ...
           <tr>
              ...
              <input type="checkbox" class="form-check-input" name="chk_1" id="sid" onchange="check()"  value="${marksheet.id}">
              ...
              <a href="${editUrl}${marksheet.id}"><s:message code="label.edit"/> <i class="fas fa-edit"></i></a>
