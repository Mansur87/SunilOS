...
/**
 * Role functionality Controller. Performs operation for add,update,delete and find list
...
public class RoleCtl extends BaseCtl{
	...
	public String display(@ModelAttribute("form") RoleForm form, Model model) {
