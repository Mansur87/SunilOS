...
/**
 * subject functionality Controller. Performs operation for add,update,delete and find list
...
public class SubjectCtl extends BaseCtl{
	...
	public String submit(@RequestParam String operation, Model model, @ModelAttribute("form") @Valid SubjectForm form, BindingResult bindingResult, HttpSession session, Locale locale) {
