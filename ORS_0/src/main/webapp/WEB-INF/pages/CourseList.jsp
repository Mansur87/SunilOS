	...
	<div class="modal-body">	  
     ...
     <div class="row" style="margin-left:3px;">
			   ...
			   <sf:select path="Id" Class="form-control">
				...
				<div class="col-md-3">
			    <div class="form-group">
			     <s:message code="label.searchduration" var="duration"/> 
			    <sf:input path="courseDuration" cssClass="form-control" placeholder="${duration}"  />
               </div>
				</div>
         ...
         <h3 class="success justify-content-center  text-center "><font color="green"> ${success}</font></h3>
          ...
          <c:if test="${!empty list}">
           ...
           <tr>
              ...
              <input type="checkbox" class="form-check-input" name="chk_1" id="sid" onchange="check()" value="${course.id}">
            ...
            <c:out value="${(form.pageSize * (form.pageNo-1))+ct.index+1}" />
              ...
              <a href="${editUrl}${course.id}"><s:message code="label.edit"/> <i class="fas fa-edit"></i></a>
