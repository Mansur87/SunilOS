...
<div class="container-fluid">
	...
	<div class="modal-body">	  
     ...
     <div class="row" style="margin-left:3px;">
			    ...
			    <s:message code="label.searchsubjectName" var="subjectname"/>
			    
			    <sf:input path="subjectName" cssClass="form-control" placeholder="${subjectname}"  />
         ...
         <h3 class="success justify-content-center  text-center "><font color="green"> ${success}</font></h3>
          ...
          <c:if test="${!empty list}">
           ...
           <tr>
              ...
              <input type="checkbox" class="form-check-input" name="chk_1" id="sid" onchange="check()" value="${subject.id}">
            ...
            <c:out value="${(form.pageSize * (form.pageNo-1))+ct.index+1}" />
              ...
              <a href="${editUrl}${subject.id}"><s:message code="label.edit"/> <i class="fas fa-edit"></i></a>
