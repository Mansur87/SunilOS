...
<div class="container-fluid">
    <div class="row">
     ...
     <div class="row" style="margin-left:3px;">
				...
				<div class="col-md-3">
			    <div class="form-group">
			    <s:message code="label.searchlogin" var="lname"/>
			    <sf:input path="login" cssClass="form-control" placeholder="${lname}"  />
               </div>
				</div>
			...
			<div class="col-md-1"></div>
                ...
                <ul class="pagination float-right" style="margin-right:10px;">
				 ...
				 <li class="page-item"><a class="page-link" >
			      <s:message code="label.pageNo"/>:<c:out value="${form.pageNo}"></c:out> 
			     </a></li>
         ...
         <h3 class="success justify-content-center  text-center "><font color="green"> ${success}</font></h3>
          ...
          <c:if test="${!empty list}">
           ...
           <tr>
              ...
              </c:choose> <c:if test="${user.roleId==1}">disabled</c:if>>
            ...
            <c:out value="${(form.pageSize * (form.pageNo-1))+ct.index+1}" />
              ...
              <c:choose>
              <c:when test="${user.roleId!=1}">
              <a href="${editUrl}${user.id}"><s:message code="label.edit"/> <i class="fas fa-edit"></i></a>
              </c:when>
