...
<div class="container-fluid">
	...
	<div class="modal-body">	  
     ...
     <div class="row" style="margin-left:3px;">
			    ...
			    <s:message code="label.searchcollege" var="collegename"/>
			    <sf:select path="collegeId" Class="form-control">
                <sf:option value="0" label="${collegename}" />
                <sf:options items="${collegeList}" itemValue="id" itemLabel="city"/>
                </sf:select>  
				...
				<div class="col-md-3">
			    <div class="form-group">
			    <s:message code="label.searchfname" var="fname"/>
			    <sf:input path="lastName" cssClass="form-control" placeholder="${fname}"  />
                </div>
				</div>
         ...
         <h3 class="success justify-content-center  text-center "><font color="green"> ${success}</font></h3>
          ...
          <c:if test="${!empty list}">
           ...
           <tr>
              ...
              <input type="checkbox" class="form-check-input" name="chk_1" id="sid" onchange="check()"  value="${student.id}">
              ...
              <a href="${editUrl}${student.id}"><s:message code="label.edit"/> <i class="fas fa-edit"></i></a>
