...
<div class="container-fluid">
	...
	<div class="modal-body">	  
     ...
     <div class="row" style="margin-left:3px;">
			    ...
			    <sf:input path="firstName" cssClass="form-control" placeholder="${fname}"  />
                </div>
				</div>
         ...
         <h3 class="success justify-content-center  text-center "><font color="green"> ${success}</font></h3>
          ...
          <c:if test="${!empty list}">
           ...
           <tr>
              ...
              <input type="checkbox" class="form-check-input" name="chk_1" id="sid" onchange="check()"  value="${faculty.id}">
              ...
              <%-- <c:out value="${user.id}" /> --%>
                    ...
                    <td><c:out value="${faculty.subjectName}" /></td>
              ...
              <a href="${editUrl}${faculty.id}"><s:message code="label.edit"/> <i class="fas fa-edit"></i></a>
